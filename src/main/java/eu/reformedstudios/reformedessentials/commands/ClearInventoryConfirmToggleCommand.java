...
public class ClearInventoryConfirmToggleCommand extends CommandListener {
	...
	public ClearInventoryConfirmToggleCommand(ReformedEssentials essentials) {
	...
	public boolean exec(CommandSender sender, Command cmd, String label, String[] args) {
		...
		Bukkit.getScheduler().runTaskAsynchronously(pl, () -> {
			...
			if(dbPlayer == null) {
				Bukkit.getScheduler().runTask(pl, () -> sender.sendMessage(messaging.errorMessage("You.. dont exist?")));
				return;
			}
			...
			if(args.length < 1) {
				...
				Bukkit.getScheduler().runTask(pl, () -> player.sendMessage(messaging.successMessage("Toggled clear inventory confirm.")));
				return;
			}
			...
			Bukkit.getScheduler().runTask(pl, () -> player.sendMessage(messaging.successMessage("Set clear inventory confirm.")));
		});
		return true;
	}
