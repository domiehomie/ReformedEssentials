                ...
                dbPlayer.getHomes().forEach(home -> {
                  homes.set(homes.get().append(
                     Component.newline()
                        ...
                        .append(messaging.simpleGradient(String.valueOf(home.getX())))
                        .append(messaging.normalMessageNoPrefix(" Y: "))
                        .append(messaging.simpleGradient(String.valueOf(home.getY())))
                        .append(messaging.normalMessageNoPrefix(" Z: "))
                        .append(messaging.simpleGradient(String.valueOf(home.getZ())))
                        .append(messaging.normalMessageNoPrefix(" Pitch: "))
                        .append(messaging.simpleGradient(String.valueOf(home.getPitch())))
                        .append(messaging.normalMessageNoPrefix(" Yaw: "))
                        .append(messaging.simpleGradient(String.valueOf(home.getYaw())))
                  ));
                });
